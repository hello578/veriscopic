...
export default function EvidenceLandingPage() {
  ...
  return (
    <PublicPage variant="soft">
      ...
      <main className="text-slate-900 space-y-12 sm:space-y-16">
        {/* HERO */}
          ...
          <div className="v-container v-copy">
            ...
            <ul className="mt-10 grid gap-6 sm:grid-cols-2">
              {[
                ...
                <li
                  key={item}
                  className="rounded-lg border border-slate-200 bg-white p-6 text-slate-800 shadow-sm"
                >
                  {item}
                </li>
              ))}
        ...
        <section className="v-section">
          <div className="v-container v-copy">
            ...
            <p className="max-w-3xl text-slate-600">
              Every Evidence Pack can be independently verified using
              cryptographic hashing. No login or trust in Veriscopic is required.
            </p>
        ...
        <section className="v-section">
          <div className="v-container v-copy">
            ...
            <p className="mt-6 max-w-3xl text-slate-600">
              ...
              classify AI risk, or assess system performance. Evidence Packs
              record declared governance facts only.
            </p>
          </div>
        </section>
