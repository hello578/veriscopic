...
export default function PricingPage() {
  return (
    <main className="v-page">
      <section className="v-hero v-hero-light">
      ...
      <section className="v-section">
        <div className="v-container v-copy">
          ...
          <p>
            This ensures pricing remains aligned with <strong>audit,
              procurement, and regulatory expectations</strong>, rather than
      ...
      <section className="v-section">
        <div className="v-container v-copy">
          <h2>Why pricing isn’t tiered</h2>

          <p>
            Veriscopic does not use rigid SaaS tiers — by design.
          </p>

          <p>
            AI governance is not uniform. Two organisations of similar size can
            carry vastly different risk, and a single high-impact system can
            outweigh dozens of low-risk tools.
          </p>

          <p>
            Tiered pricing obscures this reality. Veriscopic pricing makes it
            explicit.
          </p>
        </div>
      </section>
